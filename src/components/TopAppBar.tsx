...
export default function TopAppBar({ 
  ...
  return (
    <>
      <header className="fixed top-0 left-0 w-full z-50 bg-surface border-b border-outline-variant flex justify-between items-end px-6 pb-3 pt-[env(safe-area-inset-top,0px)] h-[calc(4rem+env(safe-area-inset-top,0px))] transition-colors duration-500">
