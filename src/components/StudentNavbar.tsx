...
export default function StudentNavbar({ activePage }: StudentNavbarProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full flex justify-around items-center px-2 pb-6 pt-3 bg-surface-container-highest z-50 rounded-t-3xl shadow-[0px_-10px_30px_rgba(0,0,0,0.3)] border-t border-outline-variant transition-colors duration-500">
